...
\begin{figure}[ht]
    ...
    \centering
    \includegraphics[angle=90, scale=0.35]{../test20.png}
    \label{fig:test-20}
\end{figure}
...
\section{Generalization, Single Subset}
